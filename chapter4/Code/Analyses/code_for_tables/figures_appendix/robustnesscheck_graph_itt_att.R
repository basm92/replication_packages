# code for ITT/ATT Graph - alternative version robustness
library(tidyverse)
...
covariates = c("lifespan", "distance_bp_hag", "birthplace_indus", "no_candidates", "howmany_before")
...
cowplot::save_plot("./figures_appendix/robust_t_star_appendix.pdf", final_plot, base_width = 12, base_height = 8)
