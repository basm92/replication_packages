...
# make table
notitie <- "Table showing Bias-corrected and Robust standard errors clustered at the Birthplace-level. The dependent variable in all cases is Log(1+Wealth). All effects are estimated under the MSE-optimal bandwidth. Panel A shows the differences in political rents before and after the suffrage extension in 1887. Panel B shows the differences in returns to politics before and after the suffrage extension in 1896. Panel C shows the differences in returns between elections with a positive turnout difference vis-a-vis elections with a negative turnout differences in comparison to the preceding general election. In panels A and C, I control for age, lifespan, newspaper recommendations and economic composition of the district and the politicians' birthplace. In panel B, due to data constraints, I control for age, lifespance and newspaper recommendations. *: p < 0.10, **: p < 0.05, ***: p < 0.01."
...
datasummary_df(bind_rows(panel_a, panel_b, panel_c) %>%
               ...
               out = "kableExtra",
               output = "latex",
               title = "RD Estimates - Suffrage Extension and Turnout") %>%
