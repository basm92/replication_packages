#robustnesscheck_mainresults_kernel
...
panel_a <- data.frame(names = c("Coefficient (ITT)", 
                                ...
                                "N (Non-Politicians)",
                                "Bandwidth"),
                      an_defw = get_info(firstrents_firsttry, 'defw', covs = NULL, bwselect = 'msecomb2', kernel='uniform'),
                      an_defw_w = get_info(firstrents_firsttry, 'defw', bw_mult = 2, bwselect = 'msecomb2', kernel='uniform'),
                      an_defw_cov = get_info(firstrents_firsttry, 'defw', covs = covariates, bwselect = 'msecomb2', kernel='uniform'),
                      an_defw2_cov = get_info(firstrents_firsttry, 'defw', covs = covariates, bw_mult = 2, bwselect = 'msecomb2', kernel='uniform'),
                      an_defw_sec_cov = get_info(firstrents_secondtry, 'defw', covs = covariates3, bwselect = 'msecomb2', kernel='uniform'),
                      an_defw2_sec_cov = get_info(firstrents_secondtry, 'defw', covs = covariates3, bw_mult = 2, bwselect = 'msecomb2', kernel='uniform'),
                      an_defw_pooled_cov = get_info(firstrents_pooled, 'defw', covs = covariates2, bwselect = 'msecomb2', kernel='uniform'),
                      an_defw2_pooled_cov = get_info(firstrents_pooled, 'defw', covs = covariates2, bw_mult = 2, bwselect = 'msecomb2', kernel='uniform'))
...
panel_b <- data.frame(names = c("Coefficient (ITT)", 
                                ...
                                "N (Non-Politicians)",
                                "Bandwidth"),
                      an_defw = get_info(firstrents_firsttry, 'defw', covs = NULL, bwselect = 'msecomb2', kernel='epanechnikov'),
                      an_defw_w = get_info(firstrents_firsttry, 'defw', bw_mult = 2, bwselect = 'msecomb2', kernel='epanechnikov'),
                      an_defw_cov = get_info(firstrents_firsttry, 'defw', covs = covariates, bwselect = 'msecomb2', kernel='epanechnikov'),
                      an_defw2_cov = get_info(firstrents_firsttry, 'defw', covs = covariates, bw_mult = 2, bwselect = 'msecomb2', kernel='epanechnikov'),
                      an_defw_sec_cov = get_info(firstrents_secondtry, 'defw', covs = covariates3, bwselect = 'msecomb2', kernel='epanechnikov'),
                      an_defw2_sec_cov = get_info(firstrents_secondtry, 'defw', covs = covariates3, bw_mult = 2, bwselect = 'msecomb2', kernel='epanechnikov'),
                      an_defw_pooled_cov = get_info(firstrents_pooled, 'defw', covs = covariates2, bwselect = 'msecomb2', kernel='epanechnikov'),
                      an_defw2_pooled_cov = get_info(firstrents_pooled, 'defw', covs = covariates2, bw_mult = 2, bwselect = 'msecomb2', kernel='epanechnikov'))
...
knitr::opts_current$set(label = "mainresults_robust_kernel")
datasummary_df(bind_rows(panel_a, panel_b) %>%
               ...
               out = "kableExtra",
               output = "latex",
               title = "Robustness to Main RD Estimates - 1st Period: Kernel") %>%
  kableExtra::add_header_above(c(" " = 1, "First Triers" = 4, "Second Triers" = 2, "All Triers" = 2)) %>%
  kableExtra::group_rows("Panel A: Uniform Kernel", 1, 7) %>%
  kableExtra::group_rows("Panel B: Yepanechnikov Kernel", 8, 14) %>%
  ...
  kableExtra::save_kable("./tables_appendix/robustness_rdd_mainresults_firststint_kernel.tex")
